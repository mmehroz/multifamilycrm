...
<div class ="page-wrapper">
    ...
    <div class ="dash-url">
        <a href="{{URL('/investerlist')}}"> <span style ="color:#4D525B">Invester List </span> <span style ="color:#A2A2A2">  > Add Invester  </span> </a>
    </div>
    @endif
    <section id ="profile-sec">
        <form method="Post" action="{{url('/submitinvester')}}" class ="user-profile-form">
            {{ csrf_field() }}
